...
$(function() {
	$( "#slider-range" ).slider({
	  ...
	  min: 600000,
	  max: 1500000,
	  values: [ 600000, 850000 ],
	  slide: function( event, ui ) {
		$( "#amount" ).val( "Сум: " + ui.values[ 0 ] + " - Сум: " + ui.values[ 1 ] );
	  }
	});
	$( "#amount" ).val( "Сум: " + $( "#slider-range" ).slider( "values", 0 ) +
	  " - Сум: " + $( "#slider-range" ).slider( "values", 1 ) );
});
...
const firstCardWidth = carousel.querySelector(".recommendation__card").offsetWidth;
